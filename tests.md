...
6. Click `Review` and confirm the dropdown closes and the review pane opens; reopen the dropdown, click `Review` again, and confirm the dropdown closes and the pane toggles closed.
